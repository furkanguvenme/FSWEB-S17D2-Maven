...
public class DeveloperController {
    ...
    @PostConstruct
    public void init(){
        developers.put(1,new Developer(1,"Halil", 5000.0, Experience.JUNIOR));
        developers.put(2,new Developer(2,"Yunus", 45000.0,Experience.MID));
        developers.put(3,new Developer(3,"Emrah", 60000.0, Experience.SENIOR));
    }
